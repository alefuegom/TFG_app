...
urlpatterns = [
    ...
    path('solicitudServicio/filterByState/<str:estado>/', views.list_solicitudServicioByState_administrador),
    path('solicitudServicio/filterByClientDNI/<str:dni>/', views.list_solicitudServicioByClientDni_administrador),
