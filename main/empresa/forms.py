...
class EditPerfilEmpresaForm(forms.Form):
    ...
    cif = forms.CharField(label="CIF", validators=[CIF_REGEX],
                          error_messages={'required': 'El campo CIF no puede estar vacío.'})
    ...
    cuentaBancaria = forms.CharField(label="Cuenta bancaria", validators=[CUENTA_BANCARIA_REGEX],
                                     error_messages={'required': 'El campo cuenta bancaria no puede estar vacío.'})
